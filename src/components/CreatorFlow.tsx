      ...
      <AnimatePresence mode="wait">
        ...
        {step === 1 && (
          <motion.div
            ...
            transition={{ duration: 0.4 }}
          >
            <p className="text-gray-500 text-sm mb-2 uppercase tracking-wide">Step 1 of 3</p>
        ...
        {step === 2 && (
          <motion.div
            ...
            transition={{ duration: 0.4 }}
          >
            <p className="text-gray-500 text-sm mb-2 uppercase tracking-wide">Step 2 of 3</p>
            <h2 className="text-2xl md:text-4xl font-bold mb-2">
        ...
        {step === 3 && (
          <motion.div
            ...
            transition={{ duration: 0.4 }}
          >
            <p className="text-gray-500 text-sm mb-2 uppercase tracking-wide">Step 3 of 3</p>
            <h2 className="text-2xl md:text-4xl font-bold mb-2">
